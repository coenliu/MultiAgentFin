...
if __name__ == "__main__":
    ...
    # runtime = SingleThreadedAgentRuntime()
    # if "reason_agent" in [agent[0] for agent in AGENT_SEQUENCES[agent_sequence]]:
    ...
    # if "extract_agent" in [agent[0] for agent in AGENT_SEQUENCES[agent_sequence]]:
    ...
    # if "executor_agent" in [agent[0] for agent in AGENT_SEQUENCES[agent_sequence]]:
    ...
    # if "verifier_agent" in [agent[0] for agent in AGENT_SEQUENCES[agent_sequence]]:

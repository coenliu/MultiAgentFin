...
TOP_N=50 #
DATASET_NAME="CodeTAT-QA" #CodeFinQA,FinCode,  CodeTAT-QA, TAT-QA,  SEC-NUM,ConvFinQA, FinancialMath
CONFIG_FILE="configs/config.yaml"
OUTPUT_PATH="results/test/test_full"  # Update the output path for results
OUTPUT_FILE="Test_rollout20_Action_CodeTAT-QA_code13B_full_2.csv" #

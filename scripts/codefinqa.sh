...
TOP_N=20 # Update as needed to limit the number of samples
DATASET_NAME="CodeFinQA" #CodeFinQA,FinCode,  CodeTAT-QA, TAT-QA,  SEC-NUM,ConvFinQA,
CONFIG_FILE="configs/config.yaml"
OUTPUT_PATH="results/"  # Update the output path for results
OUTPUT_FILE="Test_rollout20_Action_CodeFinQA_code13B_coro_full.csv" #
